...
<header class="header_top">
    <div class="container">
        <div class="header_top_main">
            ...
            <div class="header_top_item">
                <a href="<?php echo e(route('system')); ?>" class="text-light text-decoration-none"><span><i
        ...
        <div class="nav_box_item">
            <div class="nav-brand">
                ...
                <div class="nav_img_logo">
                    <?php $__currentLoopData = $banners_4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="/">
                            <img src="<?php echo e(asset($item->image_desktop)); ?>" alt="<?php echo e($item->title); ?>" />
                        </a>
            ...
            <div class="nav_box_menu">
                <ul class="nav_box_menu_item show-menu">
                    ...
                    <li class="parent-menu">
                        <a href="" class="toggle-submenu">Bộ theo chủ đề</a>
                    </li>
                    <li><a href="<?php echo e(route('policy')); ?>">Chính sách</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>">Liên hệ</a></li>
                    <li><a href="<?php echo e(route('categoryArticleUser')); ?>">Bài viết </a></li>
                    <li><a href="<?php echo e(route('book')); ?>">Book loft </a></li>
            ...
            <div class="nav_box_menu_right">
                ...
                <div class="header_user_click">
                    <div class="header_user_img">
                        <img src="<?php echo e(asset('img/user.svg')); ?>" alt="" />
                    </div>
                    <div class="header_user_content">
                        <div class="header_user_content_moc_item">
                            <img src="<?php echo e(asset('img/legomini.svg')); ?>" alt="" />
                        </div>
                        <div class="m-0 p-0">
                            <?php if(auth()->guard()->check()): ?>
                                <div class="btn_contain">
                                    <button class="btn-register" onclick="window.location.href='<?php echo e(route('member')); ?>'">Tài
                                        khoản của tôi</button>
                                </div>
                                <div class="btn_contain">
                                    <button class="btn-login" onclick="window.location.href='<?php echo e(route('logout')); ?>'">Đăng
                                        xuất</button>
                                </div>
                            <?php else: ?>
                                <div class="btn_contain">
                                    <button class="btn-login" onclick="window.location.href='<?php echo e(route('login')); ?>'">Đăng
                                        nhập</button>
                                </div>
                                <div class="btn_contain">
                                    <button class="btn-register"
                                        onclick="window.location.href='<?php echo e(route('register')); ?>'">Đăng ký</button>
                                </div>
                            <?php endif; ?>
                ...
                <div class="icon_shoppingbag">
                    <a href="<?php echo e(route('cart')); ?>"> <img src="<?php echo e(asset('img/shoppingbag.png')); ?>" alt="" /></a>
                </div>
                <div class="">
                    <a href="<?php echo e(route('viewFavourite')); ?>"><!--?xml version="1.0" encoding="UTF-8"?-->
    ...
    <div class="main_bar_menu_bg">
        <div class="main_bar_menu submenu">
            ...
            <ul class="main_bar_menu_list">
                <li><a href="<?php echo e(route('categoryAll')); ?>">Xem tất cả chủ đề</a></li>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="main_bar_menu_list_item">
                        <a href="#" data-category-id="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <ul class="main_bar_submenu_list">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="submenu-category" style="display: none" data-category-id="<?php echo e($category->id); ?>">
                        <?php $__currentLoopData = $category->categories_children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(route('categoryProduct', $item->id)); ?>"><?php echo e($item->name); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<!-- END NAV -->
<?php /**PATH D:\laragon\www\LARAVEL\DATN-LEGOLOFT-2024\legoloft\resources\views/layout/header.blade.php ENDPATH**/ ?>