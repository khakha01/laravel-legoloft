 ...
 <?php $__env->startSection('title', 'Admin | Sản phẩm'); ?>
 <?php $__env->startSection('content'); ?>

     <div class="container-fluid">

         <div class="searchAdmin">
             <form id="filterFormProduct" action="<?php echo e(route('searchProductAdmin')); ?>" method="POST">
                 <?php echo csrf_field(); ?>
                                 ...
                                 <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <?php $__currentLoopData = $category->categories_children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <option value="<?php echo e($item->id); ?>"
                                             <?php echo e(!empty($filter_iddm) ? ($item->id == $filter_iddm ? 'selected' : '') : ''); ?>>
                     ...
                     <div class="col-sm-4">
                         <div class="form-group mt-3">
                             ...
                             <select class="form-select  rounded-0" aria-label="Default select example"
                                 ...
                                 <option value="">Tất cả</option>
                                 <option value="1"
                                     <?php echo e(!empty($filter_status) ? ($filter_status == 1 ? 'selected' : '') : ''); ?>>Kích hoạt
                                 </option>
                                 <option value="0"
                                     <?php echo e(!empty($filter_status) ? ($filter_status == 0 ? 'selected' : '') : ''); ?>>Vô hiệu hóa
                                 </option>
                             </select>
                         </div>
                     </div>
         ...
         <form id="submitFormAdmin">
             ...
             <div class="buttonProductForm mt-3">
                 ...
                 <div class="m-0 p-0">
                     <button type="button" class="btn btnF1" onclick="window.location.href='<?php echo e(route('addProduct')); ?>'">
                         <i class="pe-2 fa-solid fa-plus" style="color: #ffffff;"></i>Tạo mới sản phẩm
                     </button>
                     <button class="btn btnF3" type="button"
                         onclick="submitForm('<?php echo e(route('checkboxCopyProduct')); ?>','post')"><i class="pe-2 fa-solid fa-copy"
                             style="color: #ffffff;"></i>Copy sản phẩm</button>
                     <button class="btn btnF2" type="button" onclick="deleteAllProduct('<?php echo e(route('deleteProduct')); ?>')"><i
                             class="pe-2 fa-solid fa-trash" style="color: #ffffff;"></i>Xóa
                         sản phẩm</button>
                     <a href="<?php echo e(route('productsExportExcel')); ?>"><button class="btn btnF5">Xuất Excel</button></a>
                     ...
                     <tbody class="table-body">
                         <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             ...
                             <tr class="">
                                 <td>
                                     <div class="d-flex justify-content-center align-items-center">
                                         <input type="checkbox" id="cbx_<?php echo e($item->id); ?>" class="hidden-xs-up"
                                             name="product_id[]" value="<?php echo e($item->id); ?>">
                                 ...
                                 <td class=""><?php echo e($item->categories->name); ?></td>
                                 <td>
                                     <div class="td_outstanding">
                                         <label class="switch_outstanding">
                                             <input type="checkbox" class="form-check-input-outstanding input_outstanding"
                                                 ...
                                                 <?php echo e($item->outstanding == 1 ? 'checked' : 0); ?>>
                                 ...
                                 <td class="">
                                     <div class="form-check form-switch">
                                         ...
                                         <label class="form-check-label"
                                             for="flexSwitchCheckChecked"><?php echo e($item->status == 1 ? 'Bật' : 'Tắt'); ?></label>
                                     </div>
                                     <div class="product_date">
                                         <span>Ngày tạo:<?php echo e($item->created_at->format('d/m/Y H:i:s')); ?></span>
                                         <span>Ngày sửa:<?php echo e($item->updated_at->format('d/m/Y H:i:s')); ?></span>
                                     </div>
                                 </td>
                                 <td class="m-0 p-0">
                                     <div class="actionAdminProduct m-0 py-3">
                                         <button class="btnActionProductAdmin1"><a
                                         ...
                                         <button type="button" class="btnActionProductAdmin2"
                                             onclick="window.location.href='<?php echo e('editProduct/' . $item->id); ?>'">
 ...
 <?php $__env->startSection('productAdminScript'); ?>
     <script>
         function deleteAllProduct(url) {
             const selectedProducts = document.querySelectorAll('input[name="product_id[]"]:checked');
     ...
     <script>
         ...
         function updateProductStatus(product_id, status, label) {
             $.ajax({
                 url: '<?php echo e(route('productUpdateStatus', ':id')); ?>'.replace(':id', product_id),
                 type: 'PUT',
                 data: {
     ...
     <script>
         ...
         function updateProductOutstanding(product_id, outstanding) {
             $.ajax({
                 url: '<?php echo e(route('productUpdateOutstanding', ':id')); ?>'.replace(':id', product_id),
                 type: 'PUT',
                 data: {
                     '_token': '<?php echo e(csrf_token()); ?>', //Việc gửi mã token này cùng với mỗi request giúp xác thực rằng request đó được gửi từ ứng dụng của bạn, chứ không phải từ một nguồn khác.
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\LARAVEL\DATN-LEGOLOFT-2024\legoloft\resources\views/admin/product.blade.php ENDPATH**/ ?>