       ...
       <section class="product" data-aos="fade-up">
           <div class="container">
               ...
               <div class="owl-carousel owl-theme">
                   <?php $__currentLoopData = $productBestseller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <?php
                           $priceDiscount = 0;
                               ...
                               <div class="product_box">
                                   <div class="product_box_effect">
                                       ...
                                       <div class="product_box_icon">
                                           <button onclick="addFavourite('<?php echo e($item->id); ?>')"
                                       ...
                                       <div class="product_box_content_out">
                                           <div class="product_box_content">
                                               <h3><a
                                                       href="<?php echo e(route('detail', $item->slug)); ?>"><?php echo e($item->name); ?></a>
                                               </h3>
                                           </div>
                                           ...
                                           <div class="product_box_content_soldout">
                                               <p>+<?php echo e($item->orderProduct->sum('quantity')); ?> Lượt mua</p>
                                           </div>
                                       </div>
                                   </div>
                               </div>
...
<?php /**PATH D:\laragon\www\LARAVEL\DATN-LEGOLOFT-2024\legoloft\resources\views/homeSoldOut.blade.php ENDPATH**/ ?>