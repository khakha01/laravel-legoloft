...
<head>
    ...
    <?php $__currentLoopData = $banners_6; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="icon" type="image/png" href="<?php echo e(asset($item->image_desktop)); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/minified/style.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/minified/style-book.min.css')); ?>">
...
<body>
    <div>
        ...
        <main>
            <div id="loading" class="loading-overlay" style="display: none;">
                <div class="loading-overlay-main">
    ...
    <?php echo $__env->yieldContent('swiperHome'); ?>
    <?php echo $__env->yieldContent('checkoutClient'); ?>
    <script>
        $(".flipbook").turn();
    </script>
    <script>
        // Hiển thị loading khi F5 hoặc tải lại trang
        window.addEventListener('beforeunload', function() {
            document.getElementById('loading').style.display = 'flex';
        });

        // Hiển thị loading khi thực hiện hành động (ví dụ: click vào nút)
    ...
    <script>
        function addFavourite(id) {
            $.ajax({
                url: '<?php echo e(route('favouriteForm')); ?>',
                type: 'POST',
                data: {
                    product_id: id,
                    status: 1,
                ...
                success: function(response) {
                    ...
                    if (response.is_favourite) {
                        ...
                        Swal.fire({
                            imageUrl: "<?php echo e(asset('img/tim.jpg')); ?>",
                            imageHeight: 150,
                            imageWidth: 150,
    ...
    <script>
        function showModalProduct(event, id, image, name, price, priceDiscount, productImages) {
            ...
            var user_id = '<?php echo e(Auth::check() ? Auth::user()->id : 0); ?>';
            var priceItem = 0;
            if (priceDiscount > 0) {
                priceItem = `
            ...
            <li>
                <div class="modal_product_left_img">
                    <img src="<?php echo e(asset('img/${img}')); ?>" alt="" />
                </div>
            </li>
            `).join('');
...
<?php /**PATH D:\laragon\www\LARAVEL\DATN-LEGOLOFT-2024\legoloft\resources\views/layout/layout.blade.php ENDPATH**/ ?>