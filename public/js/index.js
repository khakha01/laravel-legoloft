...
function memberSubmenu(element) {
    const submenu = element
        .closest("li")
        .querySelector(".layout_member_left_submenu");
    submenu.classList.toggle("show"); // Chuyển đổi trạng thái hiển thị
}

function memberSubmenuAssembly(element) {
    const submenuAssembly = element
        .closest("li")
        .querySelector(".layout_member_left_submenu");
    submenuAssembly.classList.toggle("show"); // Chuyển đổi trạng thái hiển thị
}
