 ...
 @Section('content')
     ...
     <div class="container-fluid">
         ...
         <div class="searchAdmin">
             <form id="filterFormProduct" action="{{ route('searchProductAdmin') }}" method="POST">
                 @csrf
             ...
             <div class="buttonProductForm mt-3">
                 ...
                 <div class="m-0 p-0">
                     ...
                     <button class="btn btnF3" type="button"
                         onclick="submitForm('{{ route('checkboxCopyProduct') }}','post')"><i class="pe-2 fa-solid fa-copy"
                             style="color: #ffffff;"></i>Copy sản phẩm</button>
                     <button class="btn btnF2" type="button" onclick="deleteAllProduct('{{ route('deleteProduct') }}')"><i
                             class="pe-2 fa-solid fa-trash" style="color: #ffffff;"></i>Xóa
                         sản phẩm</button>
                     <a href="{{ route('productsExportExcel') }}"><button class="btn btnF5">Xuất Excel</button></a>
