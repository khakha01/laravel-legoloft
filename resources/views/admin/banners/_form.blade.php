 <div>
     <div class="form-container">
         <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
             ...
             @endif
             <div class="mt-3">
                 <button type="submit" class="btn-save btn-submit">{{ $buttonText }}</button>
             </div>
             <div class="row my-3">
                 <div class="col-md-6">
                     <div class="mb-3">
                             ...
                             <div class="mb-3" style="display: flex;align-items: center;">
                                 ...
                                 <div class="input-group" style="justify-content: flex-start;row-gap: 5px;">
                                     <input id="image_desktop" class="form-control" type="hidden" name="image_desktop"
                                         value="{{ old('image_desktop', $banner->image_desktop ?? '') }}">
                             ...
                             <div class="mb-3" style="display: flex;align-items: center;">
                                 ...
                                 <div class="input-group" style="justify-content: flex-start;row-gap: 5px;">
                                     <input id="image_mobile" class="form-control" type="hidden" name="image_mobile"
                                         value="{{ old('image_mobile', $banner->image_mobile ?? '') }}">
                                     <span class="input-group-btn">
                 ...
                 <div class="col-md-6">
                     ...
                     <div class="mb-3 description-item">
                         ...
                         <textarea class="form-control " id="description2" name="description2" rows="4">{{ old('description2', $banner->description2 ?? '') }}</textarea>
                     </div>

                     <div class="mb-3 description-item">
                         <label for="description3" class="form-label">Description 3</label>
                         <textarea class="form-control " id="description3" name="description3" rows="4">{{ old('description3', $banner->description3 ?? '') }}</textarea>
                     </div>
                     <div class="mb-3 description-item">
                         <label for="description4" class="form-label">Description 4</label>
                         <textarea class="form-control " id="description4" name="description4" rows="4">{{ old('description4', $banner->description4 ?? '') }}</textarea>
                     </div>

                     <div class="mb-3 description-item">
                         <label for="description5" class="form-label">Description 5</label>
                         <textarea class="form-control " id="description5" name="description5" rows="4">{{ old('description5', $banner->description5 ?? '') }}</textarea>
                     </div>
             ...
             <div class="row mt-5">
                 <div class="col-md-12">
                     ...
                     <div id="subbanners-container">
                         @if ($isEdit && $banner->subBanners)
                             @foreach ($banner->subBanners as $i => $sub)
                                 <div class="card mb-2 p-3">
                                     <div class="row">
                                         <div class="col-md-6">

                                             <input type="text" name="sub_banners[{{ $i }}][title]"
                                                 class="form-control mb-2" placeholder="SubBanner Title"
                                                 value="{{ old('sub_banners.' . $i . '.title', $sub->title) }}">
                                             <input type="text"
                                                 name="sub_banners[{{ $i }}][description]"
                                                 class="form-control mb-2" placeholder="Description"
                                                 value="{{ old('sub_banners.' . $i . '.description', $sub->description) }}">
                                             <input type="text" name="sub_banners[{{ $i }}][href]"
                                                 class="form-control mb-2" placeholder="Href"
                                                 value="{{ old('sub_banners.' . $i . '.href', $sub->href) }}">
                                             <input type="text" name="sub_banners[{{ $i }}][button]"
                                                 class="form-control mb-2" placeholder="Button"
                                                 value="{{ old('sub_banners.' . $i . '.button', $sub->button) }}">
                                         </div>

                                         <div class="col-md-2">
                                             <div style="display: flex;flex-direction: column;row-gap: 8px;">
                                                 @if ($sub->image_desktop)
                                                     <img src="{{ asset($sub->image_desktop) }}" alt="Desktop Image"
                                                         class="preview_img" class="preview-img"
                                                         style="height: 100px;object-fit: contain; width: 100px;border-radius: 10px;">
                                                 @else
                                                     <img id="sub_preview_desktop_{{ $i }}" src=""
                                                         style="height: 100px;object-fit: contain; width: 100px;border-radius: 10px;">
                                                 @endif

                                                 <div class="input-group"
                                                     style="justify-content: flex-start;row-gap: 5px;">
                                                     <input id="sub_image_desktop_{{ $i }}"
                                                         class="form-control mb-2" type="hidden"
                                                         name="sub_banners[{{ $i }}][image_desktop]"
                                                         placeholder="Image Desktop URL"
                                                         value="{{ old('sub_banners.' . $i . '.image_desktop', $sub->image_desktop) }}">
                                                     <span class="input-group-btn">
                                                         <button type="button"
                                                             data-input="sub_image_desktop_{{ $i }}"
                                                             data-preview="sub_preview_desktop_{{ $i }}"
                                         ...
                                         <div class="col-md-2">
                                             <div style="display: flex;flex-direction: column;row-gap: 8px;">
                                                 ...
                                                 @if ($sub->image_mobile)
                                                     <img src="{{ asset($sub->image_mobile) }}" alt="mobile Image"
                                                         class="preview_img" class="preview-img"
                                                         style="height: 100px;object-fit: contain; width: 100px;border-radius: 10px;">
                                                 @else
                                                     <img id="sub_preview_mobile_{{ $i }}" src=""
                                                         style="height: 100px;object-fit: contain; width: 100px;border-radius: 10px;">
                                                 @endif
                                                 <div class="input-group"
                                                     style="justify-content: flex-start;row-gap: 5px;">
                                                     <input id="sub_image_mobile_{{ $i }}"
                                                         class="form-control mb-2" type="hidden"
                                                         name="sub_banners[{{ $i }}][image_mobile]"
                                                         placeholder="Image Mobile URL"
                                                         value="{{ old('sub_banners.' . $i . '.image_mobile', $sub->image_mobile) }}">
                                                     <span class="input-group-btn">
                                                         <button type="button"
                                                             data-input="sub_image_mobile_{{ $i }}"
                                                             data-preview="sub_preview_mobile_{{ $i }}"
                                                             class="btn btn-primary lfm">
                                                             <i class="fa fa-picture-o"></i> Choose
                                                         </button>
                                                     </span>
