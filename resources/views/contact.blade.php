                    ...
                    <div class="contact_right">
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST">
                            ...
                            <div class="input_form_contact">
                                <input type="text" class="contact_input" placeholder="Họ và tên" name="name"
                                    required />
                                <input type="email" class="contact_input" placeholder="Email" name="email" required />
                            </div>
                            <div class="row input_form_contact_2">
                                <input type="text" class="contact_input" placeholder="Số điện thoại" name="phone"
                                    required />
                            </div>
                            <div class="row input_form_contact_2">
                                <textarea placeholder="Nội dung" class="contact_textarea" name="message" rows="5" required></textarea>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <button type="submit" class="btn_checkout">Gửi liên hệ</button>
                                </div>
                            </div>
                        </form>
